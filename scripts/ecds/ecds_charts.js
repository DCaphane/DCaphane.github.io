...
function timeCharts() {
  ...
  seriesDaily
    ...
    .x(
      d3
        ...
        .range([d3.timeDay.offset(minDate, -3), d3.timeDay.offset(maxDate, 3)])
  ...
  chtDayofWeek
    ...
    .title(function(d) {
      return [arrWeekDays[d.key], formatNumber(average_map(d.value.map))].join(
        ": "
      );
    })
    .label(function(d) {
...
*/
  ...
  simpleMap
    ...
    .title(function(d) {
      return (
        "lsoa: " + d.key + "\nAttd: " + formatNumber(d.value ? d.value : 0)
      );
    });
