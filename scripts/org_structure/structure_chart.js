/*
D3 v5 Structure/ Hierarchy Chart
...
Useful Links
    ...
    The below demo is based on the observable demo (see link above)
...
let data = dataFlattened.map(d => {
  ...
  const expanded = d.id === "O-4"; // false for first two layers else true to show all by default
